...
function IconFind() {
  return (
    <svg className="h-7 w-7" viewBox="0 0 24 24" fill="none">
      ...
      <g id="SVGRepo_iconCarrier"> <path d="M12 17H19L14.5 10.5H17.5L12 3L6.5 10.5H9.5L5 17H12ZM12 17V21" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" /> </g>
